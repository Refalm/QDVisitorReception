...
$dbconnection->close();
?>
<div style="position:fixed;left:0px;bottom:0px;top:auto;right:auto;"><a href="./visitor_out.php" style="text-decoration:none;"><button style="font-size:24px;cursor:pointer;">⬅️ Back</button></a></div>
</body>
</html>